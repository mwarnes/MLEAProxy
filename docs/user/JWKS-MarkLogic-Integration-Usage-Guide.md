...
>
> The scripts described in this guide (`scripts/extract-jwks-keys.sh` and `scripts/cleanup-obsolete-jwks-keys.sh`) are not yet implemented. This documentation describes planned functionality for a future release.
...
- **MLEAProxy**: `http://localhost:8080/oauth/jwks` (local development)
