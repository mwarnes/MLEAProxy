...
Download `mlesproxy-2.0.5.jar` from the releases page.
...
The built JAR is located at `target/mlesproxy-2.0.5.jar`.

### Verify Installation

```bash
java -jar mlesproxy-2.0.5.jar --help
```
...
```bash
java -jar mlesproxy-2.0.5.jar --mleaproxy.ldap-debug=true --mleaproxy.ldap-listeners.ldapjson.port=30389
```
...
```bash
java -jar mlesproxy-2.0.5.jar --mleaproxy.ldap-debug=true
```
