...
public final class ProxyRequestHandler
     ...
     *                {@code null}.
     */
    public ProxyRequestHandler(ServerSet serverSet, String auth) throws GeneralSecurityException, IOException {
    ...
    public LDAPMessage processSearchRequest(final int messageID,
        ...
        LDAPMessage ldapReturnMessage = new LDAPMessage(messageID, searchResultDoneProtocolOp,
                Arrays.asList(searchResult.getResponseControls()));

        return ldapReturnMessage;
    }
