...
public final class Utils {
    ...
    public static String getCaCertificate(SamlBean samlBean) throws CertificateException, IOException {
        String content;
        if (samlBean.getConfig().getSamlCaPath() == null || samlBean.getConfig().getSamlCaPath().isEmpty()) {
            content = Utils.resourceToString("static/certificates/certificate.pem");
        } else {
            content = Files.readString(Paths.get(samlBean.getConfig().getSamlCaPath()));
        }
    ...
    public static String getCaPrivateKey(SamlBean samlBean) throws CertificateException, IOException {
        String content;
        if (samlBean.getConfig().getSamlKeyPath() == null || samlBean.getConfig().getSamlKeyPath().isEmpty()) {
            content = Utils.resourceToString("static/certificates/rsakey.pem");
        } else {
            content = Files.readString(Paths.get(samlBean.getConfig().getSamlKeyPath()));
        }
        return content;
    }
